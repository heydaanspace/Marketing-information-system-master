        ...
        <div class="row">
          <div class="col-md-8 tp-blog-left">
            <div class="row">
              ...
              $id = $_GET['id'];
              $data = array();
              $result = mysqli_query($mysqli,"SELECT * FROM tbl_perumahan WHERE id_perumahan='$id'");
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="col-md-12">
                  ...
                  include 'conndb.php';
                  $data = array();
                  $result = mysqli_query($mysqli,"SELECT * FROM tbl_perumahan WHERE nama_perumahan='Nayara Citra'");
                  while($row = mysqli_fetch_assoc($result))
                  {
                    ?>
