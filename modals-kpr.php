    ...
    <div class="modal-dialog">
      <div class="modal-content">
           ...
           <div class="row">
            <div class="col-md-6"> 
              <div class="form-group"> 
                ...
                <input type="number" class="form-control" id="principal" ng-model="principal"/>
              </div> 
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6"> 
            <div class="form-group"> 
              <label for="field-2" class="control-label">Jangka Waktu (Tahun)</label> 
        ...
        <div class="row">
          <div class="col-md-6"> 
            <div class="form-group"> 
              <label for="field-1" class="control-label">Estimasi Bunga(Fixed)</label> 
              <input type="number" class="form-control" id="rate" ng-model="bunga" />
            </div> 
          </div>
          <div class="col-md-6"> 
            <div class="form-group"> 
              <label for="field-2" id="field-4" class="control-label">Angsuran / Bulan</label> 
