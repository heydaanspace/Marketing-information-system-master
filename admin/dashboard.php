...
<head>
  ...
  <title>Citra Kedaton -Administrator</title>
        ...
        <ul>
          ...
          <li class="user-details cyan darken-2">
            ...
            <div style=" background: #5fbeaa ">
              ...
              <img src="assets/images/avatar-profil.PNG" alt="" class="circle responsive-img valign profile-image">
  ...
  <div class="content-page">
    ...
    if(isset($_GET['page'])){
      ...
      switch ($page) {
       ...
       break;	
       case 'modalseditperum':
       include "modals-edit-perumahan.php";
       break;
       case 'progres':
       include "frm-progres.php";
       break;  		
       default:
